 ...
 * 
 */
class Mvtype extends Controller
{
    ...
    public function insert()
    {
        ...
        $this->responseapi->response('mvtype/insert_mvtype', true);
    }
    ...
    public function select()
    {
        ...
        $this->responseapi->response('mvtype/get_mvtype', true);
    }
    ...
    public function update()
    {
        ...
        $this->responseapi->response('mvtype/update_mvtype', true);
    }
    ...
    public function delete()
    {
        ...
        $this->responseapi->response('mvtype/delete_mvtype', true);
    }
}

...
class Season extends Controller
{
    ...
    public function insert()
    {
        ...
        $this->responseapi->response('season/insert_season', true);
    }
    ...
    public function select()
    {
        ...
        $this->responseapi->response('season/get_season', true);
    }
    ...
    public function update()
    {
        ...
        $this->responseapi->response('season/update_season', true);
    }
    ...
    public function delete()
    {
        ...
        $this->responseapi->response('season/delete_season', true);
    }
}

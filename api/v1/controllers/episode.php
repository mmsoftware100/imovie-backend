...
class Episode extends Controller
{
    ...
    public function insert()
    {
        ...
        $this->responseapi->response('episode/insert_episode', true);
    }
    ...
    public function select()
    {
        ...
        $this->responseapi->response('episode/get_episode', true);
    }
    ...
    public function update()
    {
        ...
        $this->responseapi->response('episode/update_episode', true);
    }
    ...
    public function delete()
    {
        ...
        $this->responseapi->response('episode/delete_episode', true);
    }
}
